...
public sealed class LogService: ILogService
{
	...
	public Task Write(LogMessage msg)
	{
		switch (msg)
		{
			case LogWarning warning:
				Log.Logger.Warning(warning.Text, warning.Arguments);
				break;
			case LogError error:
				Log.Logger.Error(error.Text, error.Arguments);
				break;
			case not null:
				Log.Logger.Information(msg.Text, msg.Arguments);
				break;
		}
	...
	public void Write(LogEvent logEvent) => Log.Logger.Write(logEvent);
